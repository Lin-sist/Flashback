...
- AND this behavior SHALL be documented as the current M2 tag model
...
The system SHALL include a minimal WeChat Mini Program subscription message foundation for record unlock reminders when implemented in M2.
